...
const SignUp = () => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <img src="/Medical prescription (3).gif" alt="" className="w-[450px] lg:m-36"/>
      ...
      <div className="w-full md:w-1/2 bg-[#FFF] p-6 flex flex-col justify-center lg:pl-24">
        <div className="max-w-md w-full border lg:p-10 p-6 rounded-md">
          <h2 className="text-2xl font-bold text-black mb-8 text-center">Sign Up to Doc House</h2>
          <form>
            <div className="mb-4">
            ...
            <p className="text-center text-[#6C6B6B] text-md mb-2">Already registered ? <Link href="/signin" className="text-[#F7A582] font-bold">SIGN IN</Link></p>
