...
const Page = () => {
  ...
  const unavailableDates = [
    ...
    new Date(2024, 1, 7), // January  (Month 0 represents January)
    new Date(2024, 1, 9), // January  (Month 0 represents January)
    new Date(2024, 1, 12), // January 12, 2023 (Month 0 represents January)
    new Date(2024, 1, 20), // January  (Month 0 represents January)
    new Date(2024, 1, 24), // January 12, 2023 (Month 0 represents January)
    new Date(2024, 0, 24), // January 12, 2023 (Month 0 represents January)
    new Date(2024, 2, 7), // January  (Month 0 represents January)
    new Date(2024, 2, 9), // January  (Month 0 represents January)
    new Date(2024, 2, 12), // January 12, 2023 (Month 0 represents January)
    new Date(2024, 2, 20), // January  (Month 0 represents January)
    new Date(2024, 2, 24), // January 12, 2023 (Month 0 represents January)
    new Date(2024, 3, 7), // January  (Month 0 represents January)
    new Date(2024, 3, 9), // January  (Month 0 represents January)
    new Date(2024, 3, 12), // January 12, 2023 (Month 0 represents January)
    new Date(2024, 3, 20), // January  (Month 0 represents January)
    new Date(2024, 3, 24), // January 12, 2023 (Month 0 represents January)
