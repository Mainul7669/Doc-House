...
const banner = () => {
  return (
    <div>
      <div className="bg-[#07332F] lg:py-10 px-4 lg:px-10 pt-20 lg:pb-28">
        <div className=" flex flex-col lg:flex-row items-center lg:gap-32 lg:ml-28">
          <div className="flex-1 text-white text-center sm:text-left sm:mx-auto">
          ...
          <div className="flex-1 mt-6 lg:mt-0">
            <div className="lg:rounded-full lg:bg-[#F7A58233] lg:w-[300px] lg:h-[300px] lg:mt-0 mt-20">
              <svg
                ...
                className="w-20 h-20 lg:w-[145px] lg:h-[145px] lg:ml-0 ml-14 relative top-[120px] right-[120px] lg:top-[160px] lg:right-[120px]"
              >
              ...
              <img
                src="/Rectangle 20077.png"
                alt="Image 2"
                width="80px"
                height="80px"

                className="w-40 h-40 lg:w-[182px] lg:h-[182px] relative lg:bottom-[85px] lg:right-[62px] 
                bottom-[75px] right-[50px]"
              />

              <img
                src="/Rectangle 20076.png"
                alt="Image 2"
                width="82px"
                height="82px"

                className="w-40 h-40 lg:w-[182px] lg:h-[182px] relative bottom-[180px] left-[30px]"
              />

              <img
                src="/Rectangle 20075.png"
                alt="Image 2"
                width="82px"
                height="82px"

                className="w-40 h-40 lg:w-[182px] lg:h-[182px] lg:mr-0 mr-16 relative lg:bottom-[450px] 
                lg:left-[140px] bottom-[450px] 
                left-[125px]"
              />
              ...
              <img
                ...
                className="hidden lg:block relative bottom-[420px] right-[167px]"
              />
              ...
              <img
                ...
                className="lg:block relative lg:bottom-[800px] bottom-[950px] lg:right-[135px] right-2 "
              />
            </div>
          </div>
        </div>
