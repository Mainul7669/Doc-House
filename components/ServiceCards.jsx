...
const ServiceCards = () => {
  return (
    <div className="flex flex-col lg:flex-row lg:justify-center lg:mt-10 mx-5">
      {/* Card 1 */}
      <div className="w-[364px] h-[202px] p-4  mx-0">
        <div className="card card-side rounded-md bg-[#07332F] max-w-xs">
          <figure>
            <svg
          ...
          <div className="card-body text-white">
            <h2 className="card-title text-lg font-semibold">Opening Hours</h2>
      ...
      {/* Card 2 */}
      <div className="w-[364px] h-[202px] p-4 mx-0">
        <div className="card card-side rounded-md bg-[#F7A582] max-w-xs">
          <figure>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="50"
          ...
          <div className="card-body text-white">
            <h2 className="card-title text-lg font-semibold">Our Locations</h2>
      ...
      <div className="w-[364px] h-[202px] p-4 mx-0">
        <div className="card card-side rounded-md bg-[#07332F] max-w-xs">
          ...
          <div className="card-body text-white">
            <h2 className="card-title text-lg font-semibold">Contact Us</h2>
